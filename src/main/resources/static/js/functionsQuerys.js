function consultarReporteDate(){
	if($('#endDate').val() !="" && $('#startDate').val() !=""){
		if($('#endDate').val() > $('#startDate').val()) {
			...
			$.ajax({        
				url : 'http://129.151.106.128/api/Reservation/report-dates/'+startDate+'/'+endDate,
				type : 'GET',
				dataType : 'json',
...
function consultarReporteStatus(){
	$.ajax({        
		url : 'http://129.151.106.128/api/Reservation/report-status',
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function consultarReporteClients(){
	$.ajax({        
		url : 'http://129.151.106.128/api/Reservation/report-clients',
		type : 'GET',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
